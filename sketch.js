...
//creating dustbin
	left = createSprite(830,440,20,100);
	left1 = Bodies.rectangle(830,440,20,100,{isStatic:true});
	World.add(world,left1);

	bottom = createSprite(910,480,150,20);
	bottom1 = Bodies.rectangle(910,480,150,20,{isStatic:true});
	World.add(world,bottom1);

	right = createSprite(980,440,20,100);
	right1 = Bodies.rectangle(980,440,20,100,{isStatic:true});
